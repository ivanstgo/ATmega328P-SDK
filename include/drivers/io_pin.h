...
/**
 * @brief I/O pins of each I/O port.
 */
enum pin_num
{
    IO_PIN0,
...
/**
 * @brief General digital I/O pin direction.
 */
enum io_dir
{
    INPUT,
...
/**
 * @brief General digital I/O logic value.
 */
enum io_value
{
    LOW,
...
/**
 * @brief This enum lists every I/O pin and its function, bits [7:6] represent
 * the I/O port, bits [5:3] represent the pin number and remaining
 * bits represent the alternate functions. PN_FUNCTION.
 */
enum io_pin
{
...
/**
 * @brief Writes a logic level to a pin.
...
/**
 * @brief Enables the pin change interrupt for a given pin.
 * @param pin Input pin.
 */
void pin_enable_change_interrupt(enum io_pin pin);

/**
 * @brief Disables the pin change interrupt for a given pin.
 * @param pin Input pin.
 */
